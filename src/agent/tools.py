...
_NEWS_KEYWORDS  = [
    "最新", "近期", "新聞", "市場", "今年", "現在", "目前",
    "未來", "展望", "預期", "預測", "估", "guidance", "outlook", "前景",
]
...
TOOL_SPECS = [
    ...
    {
        "name": "tavily",
        "description": "搜尋即時新聞、近期財報解讀、競爭對手動態，以及外部分析師對未來展望的看法。",
        "use_when": "問題涉及『最新』『近期』『今年』『市場動態』『產業趨勢』『競爭對手』時；或前瞻性問題如『未來』『展望』『預期』『預測』『前景』，因法說會逐字稿只涵蓋過去發言，外部新聞/分析能補充市場最新預期",
...
- 前瞻性問題（含『未來』『展望』『預期』『預測』『前景』）應加 tavily，
  因法說會逐字稿只涵蓋過去發言，外部新聞能補充最新市場預期
- 其他情況只在問題真的需要時加 tavily 或 yfinance
"""
    try:
